      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_380px]">
        ...
        <div className="min-w-0">
          {!sourceFile ? (
            ...
            >
              <Hero compact className="lg:hidden" />
              <SectionLabel className="mx-auto mb-4 max-w-2xl">
                UPLOAD
              </SectionLabel>
            ...
            <div className="mt-4 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <button
                  ...
                  className="flex min-h-[52px] w-full items-center justify-center gap-2 rounded-lg bg-accent px-4 text-sm font-medium text-white transition-colors hover:bg-accent-dark active:bg-accent-dark disabled:cursor-not-allowed disabled:opacity-40 md:min-h-[44px]"
                >
                  {isAnalyzing ? (
                    <>
                      <Spinner />
                ...
                <button
                  ...
                  className="flex min-h-[52px] w-full items-center justify-center gap-2 rounded-lg border border-accent bg-accent-surface px-4 text-sm font-medium text-accent-light transition-colors hover:bg-accent/20 active:bg-accent/25 disabled:cursor-not-allowed disabled:opacity-40 md:min-h-[44px]"
                >
                  {isConverting ? (
                    <>
                      <Spinner />
                ...
                {resultSvg && (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="flex min-h-[44px] w-full items-center justify-center gap-2 rounded-lg bg-success px-4 text-sm font-semibold text-white transition-colors hover:bg-success/85 active:bg-success/75"
                    >
                      <DownloadIcon />
                      Download SVG
                    </button>
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex min-h-[44px] flex-1 items-center justify-center gap-1.5 rounded-lg bg-info/15 px-3 text-sm font-medium text-info transition-colors hover:bg-info/25 active:bg-info/30"
                      >
                        <DownloadIcon />
                        PNG
                      </button>
                      <button
                        ...
                        className="flex min-h-[44px] flex-1 items-center justify-center gap-1.5 rounded-lg bg-white/5 px-3 text-sm font-medium text-text-secondary transition-colors hover:bg-white/10 hover:text-text-primary active:bg-white/15"
                        aria-live="polite"
                      >
                ...
                {sourceFile && (
                  <button
                    type="button"
                    onClick={reset}
                    className="min-h-[44px] w-full rounded-lg border border-border-subtle px-4 text-sm text-text-secondary transition-colors hover:border-text-tertiary hover:text-text-primary active:bg-white/5"
                  >
                    Reset
                  </button>
                )}
